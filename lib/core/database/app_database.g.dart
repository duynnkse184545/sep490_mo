...
class $NotificationTblTable extends NotificationTbl
    with TableInfo<$NotificationTblTable, NotificationEntity> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $NotificationTblTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  static const VerificationMeta _notificationDataMeta = const VerificationMeta(
    'notificationData',
  );
  @override
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'notification_tbl';
  @override
  VerificationContext validateIntegrity(
  ...
  NotificationEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return NotificationEntity(
      ...
      notificationData: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}notification_data'],
      )!,
  ...
  @override
  $NotificationTblTable createAlias(String alias) {
    return $NotificationTblTable(attachedDatabase, alias);
  }
}
...
class NotificationEntity extends DataClass
  ...
  NotificationTblCompanion toCompanion(bool nullToAbsent) {
    return NotificationTblCompanion(
      id: Value(id),
  ...
  NotificationEntity copyWithCompanion(NotificationTblCompanion data) {
    return NotificationEntity(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  int get hashCode =>
      Object.hash(id, notificationData, isRead, createdAt, cachedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class NotificationTblCompanion extends UpdateCompanion<NotificationEntity> {
  final Value<int> id;
  final Value<String> notificationData;
  final Value<bool> isRead;
  final Value<DateTime> createdAt;
  final Value<DateTime> cachedAt;
  const NotificationTblCompanion({
    this.id = const Value.absent(),
  ...
  NotificationTblCompanion.insert({
    this.id = const Value.absent(),
  ...
  NotificationTblCompanion copyWith({
    Value<int>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('NotificationTblCompanion(')
          ..write('id: $id, ')
          ..write('notificationData: $notificationData, ')
          ..write('isRead: $isRead, ')
          ..write('createdAt: $createdAt, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $NotificationTblTable notificationTbl = $NotificationTblTable(
    this,
  );
...
typedef $$PostTblTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$NotificationTblTableCreateCompanionBuilder =
    NotificationTblCompanion Function({
      Value<int> id,
      required String notificationData,
      Value<bool> isRead,
      required DateTime createdAt,
...
typedef $$NotificationTblTableUpdateCompanionBuilder =
    NotificationTblCompanion Function({
      Value<int> id,
      Value<String> notificationData,
      Value<bool> isRead,
...
class $$NotificationTblTableFilterComposer
    extends Composer<_$AppDatabase, $NotificationTblTable> {
  $$NotificationTblTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get notificationData => $composableBuilder(
    column: $table.notificationData,
    builder: (column) => ColumnFilters(column),
  );
...
class $$NotificationTblTableOrderingComposer
    extends Composer<_$AppDatabase, $NotificationTblTable> {
  $$NotificationTblTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get notificationData => $composableBuilder(
    column: $table.notificationData,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$NotificationTblTableAnnotationComposer
    extends Composer<_$AppDatabase, $NotificationTblTable> {
  $$NotificationTblTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get notificationData => $composableBuilder(
    column: $table.notificationData,
    builder: (column) => column,
  );
...
class $$NotificationTblTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $NotificationTblTable,
          NotificationEntity,
          $$NotificationTblTableFilterComposer,
          $$NotificationTblTableOrderingComposer,
          $$NotificationTblTableAnnotationComposer,
          $$NotificationTblTableCreateCompanionBuilder,
          $$NotificationTblTableUpdateCompanionBuilder,
          (
            NotificationEntity,
            BaseReferences<
              _$AppDatabase,
  ...
  $$NotificationTblTableTableManager(
    _$AppDatabase db,
    $NotificationTblTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$NotificationTblTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$NotificationTblTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$NotificationTblTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
...
typedef $$NotificationTblTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $NotificationTblTable,
      NotificationEntity,
...
class $AppDatabaseManager {
  ...
  $$NotificationTblTableTableManager get notificationTbl =>
      $$NotificationTblTableTableManager(_db, _db.notificationTbl);
}
