...
class _AuthApiService implements AuthApiService {
  ...
  @override
  Future<ApiResponse<dynamic>> verify(String email) async {
    final _extra = <String, dynamic>{};
  ...
  Future<ApiResponse<SignInResponse>> signIn(SignInRequest request) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<ApiResponse<SignInResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/auth/login',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<SignInResponse> _value;
    try {
      _value = ApiResponse<SignInResponse>.fromJson(
        _result.data!,
