...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( List<Payment> packages)?  ready,TResult Function()?  empty,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Ready() when ready != null:
return ready(_that.packages);case _Empty() when empty != null:
return empty();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( List<Payment> packages)  ready,required TResult Function()  empty,}) {final _that = this;
switch (_that) {
case _Ready():
return ready(_that.packages);case _Empty():
return empty();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( List<Payment> packages)?  ready,TResult? Function()?  empty,}) {final _that = this;
switch (_that) {
case _Ready() when ready != null:
return ready(_that.packages);case _Empty() when empty != null:
return empty();case _:
...
class _Ready implements PaymentState {
  const _Ready(final  List<Payment> packages): _packages = packages;
  

 final  List<Payment> _packages;
 List<Payment> get packages {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Ready&&const DeepCollectionEquality().equals(other._packages, _packages));
}
...
@override
String toString() {
  return 'PaymentState.ready(packages: $packages)';
}
...
/// @nodoc
abstract mixin class _$ReadyCopyWith<$Res> implements $PaymentStateCopyWith<$Res> {
...
class _Empty implements PaymentState {
  const _Empty();
