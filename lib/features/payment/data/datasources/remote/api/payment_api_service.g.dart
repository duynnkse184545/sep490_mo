...
class _PaymentApiService implements PaymentApiService {
  ...
  @override
  Future<ApiResponse<List<Payment>>> getPackages() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<Payment>>>(
    ...
    late ApiResponse<List<Payment>> _value;
    try {
      _value = ApiResponse<List<Payment>>.fromJson(
        _result.data!,
  ...
  Future<CancelPaymentResponse> cancelPayment(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CancelPaymentResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payment/cancel/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CancelPaymentResponse _value;
    try {
      _value = CancelPaymentResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
