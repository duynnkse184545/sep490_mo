...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( List<Post> posts)?  ready,TResult Function( List<Post> posts)?  loadingMore,TResult Function()?  empty,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Ready() when ready != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( List<Post> posts)  ready,required TResult Function( List<Post> posts)  loadingMore,required TResult Function()  empty,}) {final _that = this;
switch (_that) {
case _Ready():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( List<Post> posts)?  ready,TResult? Function( List<Post> posts)?  loadingMore,TResult? Function()?  empty,}) {final _that = this;
switch (_that) {
case _Ready() when ready != null:
return ready(_that.posts);case _LoadingMore() when loadingMore != null:
return loadingMore(_that.posts);case _Empty() when empty != null:
...
class _Ready implements BookmarkState {
...
@override
String toString() {
  return 'BookmarkState.ready(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$ReadyCopyWith<$Res> implements $BookmarkStateCopyWith<$Res> {
...
class _LoadingMore implements BookmarkState {
...
@override
String toString() {
  return 'BookmarkState.loadingMore(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$LoadingMoreCopyWith<$Res> implements $BookmarkStateCopyWith<$Res> {
...
class _Empty implements BookmarkState {
  const _Empty();
