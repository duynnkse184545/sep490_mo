...
part of 'post_moderation_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PostModerationState);
}
...
/// @nodoc
class $PostModerationStateCopyWith<$Res>  {
$PostModerationStateCopyWith(PostModerationState _, $Res Function(PostModerationState) __);
}


/// Adds pattern-matching-related methods to [PostModerationState].
extension PostModerationStatePatterns on PostModerationState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( List<PostModeration> posts)?  ready,TResult Function( List<PostModeration> posts)?  loadingMore,TResult Function()?  empty,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Ready() when ready != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( List<PostModeration> posts)  ready,required TResult Function( List<PostModeration> posts)  loadingMore,required TResult Function()  empty,}) {final _that = this;
switch (_that) {
case _Ready():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( List<PostModeration> posts)?  ready,TResult? Function( List<PostModeration> posts)?  loadingMore,TResult? Function()?  empty,}) {final _that = this;
switch (_that) {
case _Ready() when ready != null:
return ready(_that.posts);case _LoadingMore() when loadingMore != null:
return loadingMore(_that.posts);case _Empty() when empty != null:
...
class _Ready implements PostModerationState {
  const _Ready(final  List<PostModeration> posts): _posts = posts;
  

 final  List<PostModeration> _posts;
 List<PostModeration> get posts {
...
/// Create a copy of PostModerationState
...
@override
String toString() {
  return 'PostModerationState.ready(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$ReadyCopyWith<$Res> implements $PostModerationStateCopyWith<$Res> {
...
class _LoadingMore implements PostModerationState {
  const _LoadingMore(final  List<PostModeration> posts): _posts = posts;
...
@override
String toString() {
  return 'PostModerationState.loadingMore(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$LoadingMoreCopyWith<$Res> implements $PostModerationStateCopyWith<$Res> {
...
class _Empty implements PostModerationState {
  const _Empty();
...
@override
String toString() {
  return 'PostModerationState.empty()';
}
