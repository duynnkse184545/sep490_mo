...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MemberListState);
}
...
/// @nodoc
class $MemberListStateCopyWith<$Res>  {
$MemberListStateCopyWith(MemberListState _, $Res Function(MemberListState) __);
}


/// Adds pattern-matching-related methods to [MemberListState].
extension MemberListStatePatterns on MemberListState {
...
class _Ready implements MemberListState {
...
@override
String toString() {
  return 'MemberListState.ready(members: $members)';
}
...
/// @nodoc
abstract mixin class _$ReadyCopyWith<$Res> implements $MemberListStateCopyWith<$Res> {
...
class _LoadingMore implements MemberListState {
...
@override
String toString() {
  return 'MemberListState.loadingMore(members: $members)';
}
...
/// @nodoc
abstract mixin class _$LoadingMoreCopyWith<$Res> implements $MemberListStateCopyWith<$Res> {
...
class _Empty implements MemberListState {
  const _Empty();
