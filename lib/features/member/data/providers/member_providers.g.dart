...
@ProviderFor(memberChecking)
final memberCheckingProvider = MemberCheckingFamily._();

final class MemberCheckingProvider
    extends
        $FunctionalProvider<
        ...
        >
    with
        $FutureModifier<MemberCheckingResponse>,
        $FutureProvider<MemberCheckingResponse> {
  MemberCheckingProvider._({
    required MemberCheckingFamily super.from,
    required int super.argument,
  }) : super(
         retry: null,
         name: r'memberCheckingProvider',
         isAutoDispose: true,
         dependencies: null,
         $allTransitiveDependencies: null,
       );
  ...
  @override
  String debugGetCreateSourceHash() => _$memberCheckingHash();

  @override
  String toString() {
    return r'memberCheckingProvider'
        ''
        '($argument)';
  }
  ...
  @$internal
  @override
  $FutureProviderElement<MemberCheckingResponse> $createElement(
    $ProviderPointer pointer,
  ) => $FutureProviderElement(pointer);

  @override
  FutureOr<MemberCheckingResponse> create(Ref ref) {
    final argument = this.argument as int;
    return memberChecking(ref, fanHubId: argument);
  }

  @override
  bool operator ==(Object other) {
    return other is MemberCheckingProvider && other.argument == argument;
  }
...
String _$memberCheckingHash() => r'a884fde41880f3d96434eb8d60c813697fa44095';

final class MemberCheckingFamily extends $Family
    with $FunctionalFamilyOverride<FutureOr<MemberCheckingResponse>, int> {
  MemberCheckingFamily._()
    : super(
        retry: null,
        name: r'memberCheckingProvider',
        dependencies: null,
  ...
  MemberCheckingProvider call({required int fanHubId}) =>
      MemberCheckingProvider._(argument: fanHubId, from: this);

  @override
  String toString() => r'memberCheckingProvider';
}
