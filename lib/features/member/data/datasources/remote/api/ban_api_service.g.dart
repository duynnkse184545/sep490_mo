...
class _BanApiService implements BanApiService {
  ...
  @override
  Future<ApiResponse<dynamic>> banMember(BanRequest banRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = banRequest;
  ...
  @override
  Future<ApiResponse<dynamic>> unbanMember(int banId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'banId': banId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
